...
const fileUpload = __importStar(require("express-fileupload"));
...
router
    .route('/sendmessage')
    .post(fileUpload({ createParentPath: true }), (0, fileExtLimiter_1.default)(['.png', '.jpg', 'jpeg']), fileSizeLimiter_1.default, contactController.sendMessage);
